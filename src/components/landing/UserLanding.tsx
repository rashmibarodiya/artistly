...
//   return (
//     <section className="bg-gradient-to-b from-marquee-bg to-marquee-bg2 text-marquee-cream py-20 px-6 relative overflow-hidden">
...
//           )}
//           {role === "USER" && (
//             <Link href="/user/mybookings" className="border border-marquee-plum px-8 py-3 rounded-full hover:bg-white/5 transition">
//               Bookings
//             </Link>
//           )}
//           {role === "ARTIST" && (
//             <Link href="/dashboard/artist" className="border border-marquee-plum px-8 py-3 rounded-full hover:bg-white/5 transition">
//               Profile
//             </Link>
//           )}
//         </div>
